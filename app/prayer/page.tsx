...
// Mock data with more precise timestamps
const MOCK_PEOPLE: Person[] = [
  {
    id: "1",
    name: "John Smith",
    group: "Family",
    lastPrayedFor: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000), // 3 days ago
    prayerRequests: [
      {
        id: "101",
        content: "Struggling with work stress",
        createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000 + 10 * 60 * 60 * 1000), // 7 days ago at 10:00 AM
        prayedForDates: [new Date(Date.now() - 3 * 24 * 60 * 60 * 1000)],
      },
      {
        id: "102",
        content: "Looking for a new job",
        createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000 + 14 * 60 * 60 * 1000), // 7 days ago at 2:00 PM
        prayedForDates: [new Date(Date.now() - 3 * 24 * 60 * 60 * 1000)],
      },
      {
        id: "108",
        content: "Dealing with family conflict",
        createdAt: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000), // 45 days ago
        prayedForDates: [new Date(Date.now() - 40 * 24 * 60 * 60 * 1000)],
      },
      {
        id: "109",
        content: "Financial struggles",
        createdAt: new Date(Date.now() - 75 * 24 * 60 * 60 * 1000), // 75 days ago
        prayedForDates: [new Date(Date.now() - 70 * 24 * 60 * 60 * 1000)],
      },
    ],
    followUps: [
      {
  ...
  },
  {
    ...
    name: "Sarah Johnson",
    group: "Church",
    lastPrayedFor: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000), // 1 day ago
    prayerRequests: [
      {
        id: "103",
        content: "Health concerns with her mother",
        createdAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
        prayedForDates: [new Date(Date.now() - 1 * 24 * 60 * 60 * 1000)],
      },
    ],
    followUps: [
      {
  ...
  },
  {
    ...
    prayerRequests: [
      {
        id: "104",
        content: "Preparing for important presentation",
        createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000), // 2 days ago at 9:00 AM
      },
      {
        id: "105",
        content: "Wisdom for team leadership",
        createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000 + 15 * 60 * 60 * 1000), // 2 days ago at 3:00 PM
      },
    ],
    followUps: [],
  },
  {
    ...
    name: "Emily Davis",
    group: "Family",
    lastPrayedFor: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000), // 5 days ago
    prayerRequests: [
      {
        id: "106",
        content: "College applications",
        createdAt: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000 + 11 * 60 * 60 * 1000), // 14 days ago at 11:00 AM
        prayedForDates: [new Date(Date.now() - 5 * 24 * 60 * 60 * 1000)],
      },
      {
        id: "107",
        content: "Upcoming exams",
        createdAt: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000 + 16 * 60 * 60 * 1000), // 14 days ago at 4:00 PM
        prayedForDates: [new Date(Date.now() - 5 * 24 * 60 * 60 * 1000)],
      },
    ],
    followUps: [
